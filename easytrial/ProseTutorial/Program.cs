...
3 - exit";
            ...
            while (option != 3)
            {
                ...
                catch (Exception e)
                {
                    ...
                    Console.Error.WriteLine("Exception message: {0}", e.StackTrace);
                }
            }
        }
        ...
        private static void LearnFromNewExample()
        {
            ...
            try
            {
                ...
                if (input != null)
                {
                    int inputExample = Int32.Parse(input.Split(",")[0]);
                    int outputExample = Int32.Parse(input.Split(",")[1]);
                    ...
                    Console.Write("{0}, {1}", inputExample, outputExample);
            ...
            ProgramSet topPrograms = _prose.LearnGrammarTopK(spec, scoreFeature, 4);
        ...
        private static void RunOnNewInput()
        {
            ...
            try
            {
                ...
                if (newInput != null)
                {
                    ...
                    int newinp = Int32.Parse(newInput);
                    State newInputState = State.CreateForExecution(Grammar.InputSymbol, newinp);
                    Console.WriteLine("Created State");
                    Console.Out.WriteLine("RESULT: {0} -> {1}", newinp, _topProgram.Invoke(newInputState));
                }
            }
            catch (Exception)
            {
