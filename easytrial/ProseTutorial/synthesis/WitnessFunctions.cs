...
namespace ProseTutorial
{
    public class WitnessFunctions : DomainLearningLogic
    {
        ...
        [WitnessFunction(nameof(Semantics.Plus), 1)]
        public ExampleSpec kToBeAdded(GrammarRule rule, ExampleSpec spec)
        {
            ...
            foreach (KeyValuePair<State, object> example in spec.Examples)
            {
                ...
                int input = (int)inputState[rule.Body[0]] ;
        ...
        [WitnessFunction(nameof(Semantics.Minus), 1)]
        public ExampleSpec kToBeSubtracted(GrammarRule rule, ExampleSpec spec)
        {
            var result = new Dictionary<State, object>();
    ...
    //     [WitnessFunction(nameof(Semantics.Minus), 1, DependsOnParameters = new[] {1})]
